...
SET_EST_TIME = 'Укажите ориентировочную дату исполнения.\n'
...
CANT_DELETE = 'У тикета есть история исполнения. Его нельзя удалить'
INVALID_DATE = 'Неверная дата. Попробуйте еще раз.'
