...
def show_order(order_id: int) -> Order:
    """Возвращает информацию по конкретному заказу. Я не знаю, что она должна принимать. Скажешь мне потом"""
    pass


def show_tickets(chat_id: int) -> list[[Ticket]]:
    """Возвращает список всех незакрытых тикетов заказчика. Я не знаю, что она должна принимать. Скажешь мне потом"""
    pass


def show_ticket(ticket_id: int) -> Ticket:
    """Возвращает информацию по конкретному тикету. Я не знаю, что она должна принимать. Скажешь мне потом"""
    pass
